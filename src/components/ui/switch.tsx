...
function Switch({
    ...
    return (
        <div className={cn("flex items-center justify-between gap-4 w-full", wrapperClassName)}>
            <div className="flex flex-col gap-2">
                {label && (
                    <label
                        htmlFor={switchId}
                        className="text-md font-normal text-foreground tracking-somewhat-tight leading-none cursor-pointer"
                    >
                        {label}
                    </label>
                )}
