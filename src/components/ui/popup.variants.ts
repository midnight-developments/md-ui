...
export const popupContentVariants = cva(
  [
    ...
    "data-[align=start]:origin-top-left data-[align=end]:origin-top-right data-[align=center]:origin-top",
    "data-[side=top]:data-[align=start]:origin-bottom-left data-[side=top]:data-[align=end]:origin-bottom-right data-[side=top]:data-[align=center]:origin-bottom",
    "data-[ending-style]:pointer-events-none data-[closed]:pointer-events-none",
    "data-[starting-style]:opacity-0 data-[ending-style]:opacity-0",
    "data-[starting-style]:scale-95 data-[ending-style]:scale-95",
    "data-[starting-style]:data-[side=bottom]:-translate-y-2 data-[ending-style]:data-[side=bottom]:-translate-y-2",
    "data-[starting-style]:data-[side=top]:translate-y-2 data-[ending-style]:data-[side=top]:translate-y-2",
    "data-[starting-style]:data-[side=left]:translate-x-2 data-[ending-style]:data-[side=left]:translate-x-2",
    "data-[starting-style]:data-[side=right]:-translate-x-2 data-[ending-style]:data-[side=right]:-translate-x-2",
  ].join(" ")
)
