...
const activeStates =
  "[&:is(:hover,:focus-within,[data-popup-open],[data-state=open],[data-active=true],[data-focused=true],[aria-expanded=true])]"

const activeRingStates =
  "[&:is(:focus-within,[data-popup-open],[data-state=open],[data-active=true],[data-focused=true],[aria-expanded=true])]"
